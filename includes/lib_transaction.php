...
{
    $sql = "SELECT *,"
			."(SELECT region_name FROM ". $GLOBALS['ecs']->table('region')." WHERE region_id = country )as country_name,"
			."(SELECT region_name FROM ". $GLOBALS['ecs']->table('region')."  WHERE region_id = province )as province_name ,"
			."(SELECT region_name FROM ". $GLOBALS['ecs']->table('region')."  WHERE region_id = city )as city_name ,"
			."(SELECT region_name FROM ". $GLOBALS['ecs']->table('region')."  WHERE region_id = district )as district_name  FROM "
