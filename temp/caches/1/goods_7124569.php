<?php exit;?>a:3:{s:8:"template";a:5:{i:0;s:62:"D:/php project/ECShop/upload/themes/ecmoban_jingdong/goods.dwt";i:1;s:76:"D:/php project/ECShop/upload/themes/ecmoban_jingdong/library/page_header.lbi";i:2;s:73:"D:/php project/ECShop/upload/themes/ecmoban_jingdong/library/comments.lbi";i:3;s:82:"D:/php project/ECShop/upload/themes/ecmoban_jingdong/library/bought_note_guide.lbi";i:4;s:76:"D:/php project/ECShop/upload/themes/ecmoban_jingdong/library/page_footer.lbi";}s:7:"expires";i:1450960205;s:8:"maketime";i:1450956605;}<!DOCTYPE html>
<html>
<head lang="en">
    <meta charset="UTF-8">
    <title></title>
...
<section class="mod_12 mb30">
    <div class="container auto">
       <!-- <span>服装衣服：</span> -->
        <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=53">手机数码</a> <code>&gt;</code> <a href="category.php?id=27">数码相机</a> <code>&gt;</code> <a href="category.php?id=32">单反相机</a> <code>&gt;</code> 佳能D700 
    </div>
</section>
<section class="container auto mb20 fix">
    <div class="mod_13 fl">
        <div class="bd">
            <ul>
			                <li>
                    <a href="#" target="_blank"><img src="images/201512/goods_img/54_P_1449720065523.jpg" /></a>
                </li>
                                <li>
                    <a href="#" target="_blank"><img src="images/201512/goods_img/54_P_1449982601121.jpg" /></a>
                </li>
                                <li>
                    <a href="#" target="_blank"><img src="images/201512/goods_img/54_P_1449982601081.jpg" /></a>
                </li>
                            </ul>
        </div>
        <div class="hd auto">
            <ul>
			                <li><img src="images/201512/goods_img/54_P_1449720065523.jpg" /></li>
                           <li><img src="images/201512/goods_img/54_P_1449982601121.jpg" /></li>
                           <li><img src="images/201512/goods_img/54_P_1449982601081.jpg" /></li>
                       </ul>
        </div>
    </div>
    <script type="text/javascript">
	 ...
	 <form action="javascript:addToCart(54)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
    <div class="mod_14 fl">
        <div class="c_1">佳能D700</div>
        <div class="c_2 mb10 fix">
            <div class="fl">
                <p>参  考  价： <span class="tdlt">￥13333元</span></p>
               
	      <script type="text/javascript" src="js/lefttime.js"></script>	<p>热  贸  价： <span  class="tdlt" >￥11111元</span></p>
      <p>促销价：<span  class="sp_1" >￥5555元</span></p>
      <p>剩余时间：<span>
      <font id="leftTime">请稍等, 正在载入中...</font></span></p>
	              </div>
            <div class="fr pt30">月销量0 <span class="sp_2"></span> 丨 累计评价<span class="sp_2">27</span></div>
        </div>
        <div class="c_3 mb15">
            <ul>
                ...
                <li class="fix">
                    ...
                    <div class="skin_3">ECS000054</div>
                </li>
				<div id="select_spec">
			      
            <li class="fix">
	  <div class="name">选择镜头:</div>
<div  class="skin_3 fix">
                                       <a name="spec_115" value="330" id="spec_value_330"  class="fix"  href="javascript:Price();" ><span>
                      4551E[ ￥0.00元]</span></a>
                                            <a name="spec_115" value="331" id="spec_value_331"  class="fix"  href="javascript:Price();" ><span>
                      rr333[加 ￥111.00元]</span></a>
                                        <input type="hidden" name="spec_list" value="1" />
      </div>
	  </li>
            <li class="fix">
	  <div class="name">选择存储卡:</div>
<div  class="skin_3 fix">
                                       <a name="spec_120" value="333" id="spec_value_333"  class="fix"  href="javascript:Price();" ><span>
                      存储卡容量[ ￥0.00元]</span></a>
                                            <a name="spec_120" value="308" id="spec_value_308"  class="fix"  href="javascript:Price();" ><span>
                      记录媒体[加 ￥33.00元]</span></a>
                                        <input type="hidden" name="spec_list" value="1" />
      </div>
	  </li>
...
<section class="container mod_16 auto mb30">
    ...
    <div class="content">
        <ul class="fix">	
	      <li >
      <a href="goods.php?id=35" target="_blank"><img src="images/201512/thumb_img/35_thumb_G_1449539593275.jpg" alt="" class="B_blue" /></a>
	  <a href="goods.php?id=35" target="_blank" title="">苹果6S</a>
      本店售价：<font class="f1">￥4546456元</font><br />
      </li>
      <li >
      <a href="goods.php?id=41" target="_blank"><img src="images/201512/thumb_img/41_thumb_G_1449703910025.jpg" alt="" class="B_blue" /></a>
	  <a href="goods.php?id=41" target="_blank" title="">戴尔笔记本</a>
      本店售价：<font class="f1">￥3333元</font><br />
      </li>
      <li >
      <a href="goods.php?id=48" target="_blank"><img src="images/201512/thumb_img/48_thumb_G_1449705721019.jpg" alt="" class="B_blue" /></a>
	  <a href="goods.php?id=48" target="_blank" title="">戴尔笔记本</a>
      本店售价：<font class="f1">￥5555元</font><br />
      </li>
      <li >
      <a href="goods.php?id=59" target="_blank"><img src="images/no_picture.gif" alt="" class="B_blue" /></a>
	  <a href="goods.php?id=59" target="_blank" title="">红豆内衣</a>
...
<section class="container auto fix mb20">
	...
	<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#dddddd">
          ...
          <td bgcolor="#FFFFFF" align="left" width="70%">单反</td>
        </tr>
                <tr>
          <td bgcolor="#FFFFFF" align="left" width="30%" class="f1">[最大像素/总像素  ]</td>
          <td bgcolor="#FFFFFF" align="left" width="70%">1233</td>
        </tr>
                <tr>
          <td bgcolor="#FFFFFF" align="left" width="30%" class="f1">[光学变焦倍数]</td>
          <td bgcolor="#FFFFFF" align="left" width="70%">11</td>
        </tr>
                <tr>
          <td bgcolor="#FFFFFF" align="left" width="30%" class="f1">[数字变焦倍数]</td>
          <td bgcolor="#FFFFFF" align="left" width="70%">13</td>
        </tr>
                <tr>
          <td bgcolor="#FFFFFF" align="left" width="30%" class="f1">[显示屏类型]</td>
          <td bgcolor="#FFFFFF" align="left" width="70%">LED</td>
        </tr>
                <tr>
          <td bgcolor="#FFFFFF" align="left" width="30%" class="f1">[最高分辨率]</td>
          <td bgcolor="#FFFFFF" align="left" width="70%">233</td>
        </tr>
                <tr>
          <td bgcolor="#FFFFFF" align="left" width="30%" class="f1">[图像分辨率]</td>
          <td bgcolor="#FFFFFF" align="left" width="70%">222*1111</td>
        </tr>
                <tr>
          <td bgcolor="#FFFFFF" align="left" width="30%" class="f1">[旋转液晶屏]</td>
          <td bgcolor="#FFFFFF" align="left" width="70%">支持</td>
        </tr>
                <tr>
          <td bgcolor="#FFFFFF" align="left" width="30%" class="f1">[影像格式]</td>
          <td bgcolor="#FFFFFF" align="left" width="70%">动画</td>
        </tr>
                		<tr>
          <th colspan="2" bgcolor="#FFFFFF"> <h2 class="h2bg"> <h2>商品描述：</h2></th>
        </tr>
		 <tr>
          <td  colspan="2" bgcolor="#FFFFFF" > <h1>&nbsp;佳能D700</h1>
<p><a href="http://item.jd.com/1433504.html#none">item.jd.com/1433504.html#none</a></p>
<p><img width="130" height="130" alt="" src="/images/upload/Image/54f17f1eN89cb3982.jpg"  /></p></td>
                ...
                <div class="list_01">
												...
												<div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:54;}554fcae493e564ee0dc75bdf2ebf94ca</div>
				...
				<div id="ECS_BOUGHT">554fcae493e564ee0dc75bdf2ebf94cabought_notes|a:2:{s:4:"name";s:12:"bought_notes";s:2:"id";i:54;}554fcae493e564ee0dc75bdf2ebf94ca</div>				
