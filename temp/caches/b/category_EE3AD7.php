<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:65:"D:/php project/ECShop/upload/themes/ecmoban_jingdong/category.dwt";i:1;s:76:"D:/php project/ECShop/upload/themes/ecmoban_jingdong/library/page_header.lbi";i:2;s:76:"D:/php project/ECShop/upload/themes/ecmoban_jingdong/library/page_footer.lbi";}s:7:"expires";i:1450960204;s:8:"maketime";i:1450956604;}<!DOCTYPE html>
<html>
<head lang="en">
    <meta charset="UTF-8">
    <title></title>
...
<section class="container mod_05 auto">
    <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=53">手机数码</a> <code>&gt;</code> <a href="category.php?id=27">数码相机</a> ：
	    <select id="categroytree" onchange="getchildid()"class="xlk_1 vm">
	        <option value="32_category.php?id=32"  >单反相机</option>
	             <option value="33_category.php?id=33"  >微单</option>
...
<section class="container auto fix">
    <div class="w_941 fl">
            ...
            <ul>
                <li class="fix">
                    ...
                    <div class="c_2 skin_2">
                        					                    <a href="#">全部</a>
                  	 														<a href="category.php?id=27&amp;brand=25&amp;price_min=0&amp;price_max=0">佳能</a>
																			<a href="category.php?id=27&amp;brand=26&amp;price_min=0&amp;price_max=0">尼康</a>
                ...
                <li class="fix">
                    ...
                    <div class="c_2 skin_2">
                								<a href="#">全部</a>
															<a href="category.php?id=27&amp;price_min=11000&amp;price_max=16000">11000&nbsp;-&nbsp;16000</a>
															<a href="category.php?id=27&amp;price_min=41000&amp;price_max=46000">41000&nbsp;-&nbsp;46000</a>
							                    </div>
                </li>
	      <li class="fix">
	   <div class="c_1">类型 :</div>
			<div class="c_2 skin_2">
											<a href="#">全部</a>
															<a href="category.php?id=27&amp;price_min=0&amp;price_max=0&amp;filter_attr=300.0.0.0.0.0.0">单反</a>&nbsp;
															<a href="category.php?id=27&amp;price_min=0&amp;price_max=0&amp;filter_attr=310.0.0.0.0.0.0">微单</a>&nbsp;
							                    </div>
                </li>
  			      <li class="fix">
	   <div class="c_1">镜头 :</div>
			<div class="c_2 skin_2">
											<a href="#">全部</a>
															<a href="category.php?id=27&amp;price_min=0&amp;price_max=0&amp;filter_attr=0.0.0.0.0.330.0">4551E</a>&nbsp;
															<a href="category.php?id=27&amp;price_min=0&amp;price_max=0&amp;filter_attr=0.0.0.0.0.331.0">rr333</a>&nbsp;
							                    </div>
                </li>
        ...
        <div class="mod_08 fix">
            <div class="con_1 fl fix">
			  ...
			  <a href="javascript:void(0);">综合排序</a>
                <a href="category.php?category=27&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=comment_num&order=DESC#goods_list">评论数</a>
  <a href="category.php?category=27&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=ASC#goods_list">上架时间</a>
  <a href="category.php?category=27&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list">价格</a>
  <a href="category.php?category=27&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list">更新时间</a>
  <a href="category.php?category=27&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_volume&order=DESC#goods_list">销量</a>
  ...
  <input type="hidden" name="order" value="DESC" />
        ...
        <div class="mod_10">
            <ul class="fix">
                    ...
                    <div class="img mb15"><a href="goods.php?id=55"><img src="images/201512/thumb_img/55_thumb_G_1449720222051.jpg" alt="尼康微单" class="goodsimg" /></a></div>
                    <div class="text">
                        <div class="c_1 fix">
						                       <span class="sp_1 fl">￥44444元</span>
                                        
                            <span class="fr">421人付款</span>
                        </div>
                        <div class="c_2">
                           <a href="goods.php?id=55" title="尼康微单">尼康微单</a>
                        </div>
                        <div class="fix">
                    ...
                    <div class="img mb15"><a href="goods.php?id=54"><img src="images/201512/thumb_img/54_thumb_G_1449720065216.jpg" alt="佳能D700" class="goodsimg" /></a></div>
                    <div class="text">
                        <div class="c_1 fix">
						                       <span class="sp_1 fl">￥5555元</span>
                                        
                            <span class="fr">421人付款</span>
                        </div>
                        <div class="c_2">
                           <a href="goods.php?id=54" title="佳能D700">佳能D700</a>
                        </div>
                        <div class="fix">
                            <a href="#" class="a_2 fl">优衣库官方旗舰店</a>
                            <span class="fr">上海</span>
