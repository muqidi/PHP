...
elseif ($_REQUEST['step'] == 'checkout')
{
	...
	$province_list = get_regions(1,$country_list[0]["region_id"]);
	...
	$consigneelist = get_consignee_list($_SESSION['user_id']);
    /* 检查收货人信息是否完整 */
  ...
  //  }
	...
	$smarty->assign('consignee_list', $consigneelist);
    /* 对商品信息赋值 */
